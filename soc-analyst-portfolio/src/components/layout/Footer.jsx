    ...
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-bg)] py-10 text-[var(--color-secondary-text)]">
      <Container className="grid gap-8 md:grid-cols-[1.5fr_1fr] lg:grid-cols-[2fr_1fr]">
        <div className="space-y-3">
          <p className="text-sm uppercase tracking-[0.3em] text-[var(--color-accent)]">{siteConfig.name}</p>
          <p className="text-lg font-semibold text-white">Junior SOC Analyst Portfolio</p>
          <p className="max-w-xl text-sm leading-7 text-[var(--color-secondary-text)]">
            Hands-on defensive security • SOC labs • security monitoring.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-[var(--color-secondary-text)]">
            © {currentYear} {siteConfig.name}. Built as a cybersecurity portfolio.
          </p>
        </div>
      </Container>
    </footer>
